					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						...
						<div class="slide-caption">
                            <div class="caption-content">
                                <h2 class="animated fadeInDown">O - MILD</h2>
                                <span class="animated fadeInDown">O - MILD</span>
                                <a href="/auth/register" class="btn btn-blue btn-effect">Join US</a>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 text-center wow animated zoomIn">
						<div class="service-item">
							...
							<h3>Write Stories</h3>
							<p>Whatever story you want to tell, there is a reader waiting for you on O-MILD </p>
						</div>
					</div>
